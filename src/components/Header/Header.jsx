...
const Header = () => {
  ...
  return (
    ...
    <div
      className = {`navbar w-full h-4 bottom-2 flex justify-between border-none max-[737px]:flex-col max-[737px]:items-start max-[737px]:gap-2 max-[737px]:justify-start ${menu?'max-[737px]:overflow-hidden':'max-[737px]:overflow-scroll'}  ${menu?'max-[737px]:h-1':'max-[737px]:h-full'} ${!menu?'max-[737px]:bg-[#EBEBEB]':''}  ${!menu?'text-[#878787]':''} fixed top-0 z-50 px-5 `}
      id="navbar"
    >
      {/* logo */}
      <div className="logo">
        <HashLink to={"/#home"} className="navbar-header-logo text-black max-[737px]:absolute top-2 cursor-pointer dark:text-white">Ankit</HashLink>
      </div>

      <div
        className = {`max-[737px]:rounded-none nav-links flex h-full rounded-full max-[737px]:flex-col max-[737px]:h-fit max-[737px]:w-full max-[737px]:mt-28 max-[737px]:mb-10 max-[737px]:items-center max-[737px]:justify-center  max-[737px]:gap-0  max-[900px]:gap-1 ${menu?'max-[737px]:opacity-0':'max-[737px]:opacity-1'} ${menu?'max-[737px]:pointer-events-none':'max-[737px]:pointer-events-all'} 
       min-[737px]:bg-[rgba(255,_255,_255,_0.45)] min-[737px]:backdrop-filter min-[737px]:backdrop-blur-[10px] min-[737px]:border-[1px] min-[737px]:border-solid min-[737px]:border-[rgba(255,255,255,.25)] min-[737px]:overflow-hidden min-[737px]:ml-5 `}     
        id="nav-links"
      >
        ...
        <HashLink  to={"#about"} className= {`hover:text-white hover:bg-gradient-to-r from-purple-500 to-pink-500 text-[#878787] dark:text-white font-normal h-full p-3 px-6 max-[737px]:w-full max-[737px]:hover:bg-black max-[737px]:hover:text-white dark:max-[737px]:hover:bg-white dark:max-[737px]:hover:text-black max-[737px]:text-center max-[737px]:rounded-2xl dark:max-[737px]:text-[#878787] max-[737px]:pt-2 transition ease-in-out duration-150  cursor-pointer ${!menu?'text-[#878787]':''} `} onClick={()=>showLinksMenu()}>
          About
        </HashLink >

        <HashLink  to={"/#projects"} className="hover:text-white hover:bg-gradient-to-r from-purple-500 to-pink-500 text-[#878787] dark:text-white font-normal h-full p-3 px-6 max-[737px]:w-full max-[737px]:hover:bg-black max-[737px]:hover:text-white dark:max-[737px]:hover:bg-white dark:max-[737px]:hover:text-black max-[737px]:text-center max-[737px]:rounded-2xl max-[737px]:pt-2 transition ease-in-out duration-150 cursor-pointer dark:max-[737px]:text-[#878787]" onClick={()=>showLinksMenu()}>
          Projects
        </HashLink >

        <HashLink to={"/#contactus"} className="hover:text-white hover:bg-gradient-to-r from-purple-500 to-pink-500 text-[#878787] dark:text-white font-normal h-full p-3 px-6 max-[737px]:w-full max-[737px]:hover:bg-black max-[737px]:hover:text-white dark:max-[737px]:hover:bg-white dark:max-[737px]:hover:text-black max-[737px]:text-center max-[737px]:rounded-2xl max-[737px]:pt-2 transition ease-in-out duration-200 rounded-r-2xl cursor-pointer dark:max-[737px]:text-[#878787]" onClick={()=>showLinksMenu()}>
          Contact Us
        </HashLink >
      ...
      <div className="colormode-and-button-part flex gap-3 max-[737px]:w-full max-[737px]:justify-center">
        ...
        ${menu?'max-[737px]:hidden':'max-[737px]:block hover:scale-90 transition-all duration-500 ease-in-out'} max-[900px]:text-sm  max-[900px]:px-3
