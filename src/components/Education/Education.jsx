...
<div className={`min-h-full w-full flex flex-col p-3 py-10 gap-6 text-black relative justify-center ${dark?'bg-gradient-to-r from-zinc-700 to-slate-900':'bg-gradient-to-r from-blue-600 to-fuchsia-500'} pt-16`}>
    <Slide duration={2000}> <h1 className={`max-[900px]:text-4xl text-5xl text-center mb-10 text-white font-medium`} id="education">Education👨🏻‍🎓</h1>
      </Slide>    
      ...
      <div className="line absolute right-1/4 h-4/6 w-1 bg-gradient-to-r from-rose-100 to-teal-100 max-[583px]:right-6">
